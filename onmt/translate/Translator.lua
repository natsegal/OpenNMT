...
function Translator:translateBatch(batch)
  ...
  local results = beamSearcher:search(self.opt.beam_size, self.opt.n_best, self.opt.pre_filter_factor, false, self.opt.diverse_history, self.opt.diverse_tokens)
